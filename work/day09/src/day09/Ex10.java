...
class MyOverValueException2 extends Exception{
	public MyOverValueException2(String m) {
		super(m);
	}
}
...
public class Ex10 {
	...
	static int input() throws MyOverValueException2 {
		int ret = in.nextInt();
		if(ret > 10) {
			throw new MyOverValueException2("10이상 입력 예외");
		}
		return ret;
	}
